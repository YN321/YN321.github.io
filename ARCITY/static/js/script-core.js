(function($){
	...
	$(document).ready(function(){
		...
		$('#arki-side-content-menu').each(function(){
			...
			var cross_button = $('.arki-side-content-menu-close');
			menu_button.on('click', function(){
				menu_button.removeClass('arki-active');
				menu_button.fadeOut(1);
				side_content_menu.fadeIn(300);
				side_content_menu.addClass('arki-active');
				cross_button.fadeIn(1);
				cross_button.addClass('arki-active');

			});

			side_content_menu.on('click', '.arki-side-content-menu-button', function(){
			...
			cross_button.on('click',  function(){
				side_content_menu.removeClass('arki-active');
				side_content_menu.fadeOut(300);
				menu_button.fadeIn(1);
				menu_button.addClass('arki-active');
				cross_button.removeClass('arki-active');
				cross_button.fadeOut(1);
